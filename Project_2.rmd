...
hotel_knn <- train(is_canceled ~  ., data = hotel, method = "knn", metric = "Kappa", trControl = ctrl, preProcess = c("center","scale"), tuneLength = 20)

hotel_knn
matrix_knn <- confusionMatrix(hotel_knn, norm = "none")
matrix_knn
